...
app.get('/api/prompts', async (req, res) => {
  try {
    ...
    if (userId) {
      // UserId in prompt table is d-xxx.user_id, while the actual UserId is user_id => Use contains() to match userId as part of the stored UserId which may have a prefix
